...
<tr>
   ...
   <td align="center"><input name="batch_no" type="text" style="width:150px" required="required" placeholder="batch no"/></td>
</tr>
 <tr>
    <td align="center">&nbsp;</td>
    </tr>
...
<tr>
   ...
   <td align="center"><input name="avail_quantity" type="text" style="width:150px" required="required" placeholder=" quantity"/></td>
</tr>
 <tr>
    <td align="center">&nbsp;</td>
    </tr>
<tr>
   ...
   <td align="center"><input name="cost" type="text" style="width:150px" required="required" placeholder="cost"/></td>
</tr>
 <tr>
    <td align="center">&nbsp;</td>
    </tr>
...
<tr>
     ...
     <td align="center"><input name="date" type="date" style="width:150px" required="required" placeholder="date"/></td>
</tr>
	 <tr>
    <td align="center">&nbsp;</td>
    </tr>
<tr>
    ...
    <td align="center"><input name="expire_date" type="date" style="width:150px" required="required" placeholder="expiry date"/></td>
</tr>

<tr>
	<td><h1 style="font-family:Constantia;"><font size="2px">STOCK NAME</font></h3></td>
			<td align="center">
