...
?>
	<table class="table">
		<tr>
			...
			?>
		<tr>
			<td><?php echo $book['med_title'] . " by " . $book['med_dom']; ?></td>
			<td><?php echo "$" . $book['med_price']; ?></td>
			<td><?php echo $qty; ?></td>
			<td><?php echo "$" . $qty * $book['med_price']; ?></td>
		</tr>
		<?php } ?>
		<tr>
			<th>&nbsp;</th>
...
<?php
		...
		echo "<p class=\"text-warning\">Your cart is empty! Please make sure you add some meds in it!</p>";
	}
